...
def upgrade() -> None:
    ...
    with op.batch_alter_table("apuntes") as batch_op:
        ...
        batch_op.add_column(sa.Column("tipo_contenido", sa.String(50), server_default="pdf", nullable=False))
        batch_op.add_column(sa.Column("likes", sa.Integer(), server_default="0", nullable=False))
        batch_op.add_column(sa.Column("descargas", sa.Integer(), server_default="0", nullable=False))
        batch_op.add_column(sa.Column("visibilidad", sa.String(20), server_default="publico", nullable=False))
        batch_op.add_column(sa.Column("fecha_subida", sa.DateTime(), server_default=sa.func.now(), nullable=True))
        if is_sqlite:
